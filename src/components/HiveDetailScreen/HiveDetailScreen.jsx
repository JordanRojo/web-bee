...
  // --- NUEVOS ESTADOS PARA EL MODAL DE REPORTE ---
  const [isReportModalOpen, setIsReportModalOpen] = useState(false);
  const [selectedObservations, setSelectedObservations] = useState([]);
  const [customObservation, setCustomObservation] = useState("");

  // ----------------------------------------------------
  // --- Funciones de Fetching (Restauradas) ---
  // ----------------------------------------------------
...
  // ----------------------------------------------------
  // --- Lógica de Observaciones del Reporte ---
  // ----------------------------------------------------
...
    try {
      const encodedObservations = encodeURIComponent(JSON.stringify(observaciones));
      
      // Usamos GET, pasando las observaciones codificadas en el query param 'obs'
      const response = await axios.get(
        `${API_URL}/reportes/obtener-reporte/${hiveId}/${userId}?obs=${encodedObservations}`,
        {
          responseType: "blob", 
...
  // ----------------------------------------------------
  // --- Lógica y Helpers (Restauradas) ---
  // ----------------------------------------------------
  
  // Usando datos del estado 'sensoresPorDia'
...
          return { status: "critical", icon: <FaTimesCircle />, label: "Crítico" };
...
    // **AVISO**: `sampleHiveData` no está definido en el código proporcionado. 
    // Si no tienes una fuente de datos histórica detallada, esto generará un error.
    // Asumo que existe o lo estás reemplazando por una versión simplificada.
